...
# Generate a secret key and put it in a file called .env such as
...
ALLOWED_HOSTS = ["127.0.0.1", ".pythonanywhere.com", "survey.research.aeterna.eu"]
...
CSRF_TRUSTED_ORIGINS = ["https://survey.research.aeterna.eu"]
